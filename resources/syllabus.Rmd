...
Your review should be 1-2 pages, and provide helpful feedback for the author. The following questions may be useful:

- Is the question clearly stated and well motivated?
- Does the data analysis help you understand the context?
...
You can use [the requirements for the final project](https://github.com/CPLN-680-Spring-2022/Class-Resources/blob/main/resources/final_project.pdf) as aadditional guidance.
