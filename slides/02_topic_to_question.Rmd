...
- **Disagreement**: Some people think X, but other people think Y. What's right?
...
- Is your question too broad to have an "answer"?
...
## Some strategies for questions

- Read an existing paper/project and...
    - Read their extension questions.
    - Ask if there's a spatial extension.
        - Use spatial boundaries?
        - Add distance?
        - Map residuals?
- Talk to a subject matter expert and see if there are open optimization problems.
...
- 1/28 (next week): GitHub Repo with raw data. We will be *Virtual*.
- 2/4: Data Summary Analysis and 10-minute presentations (with 5-minute question).
- 2/11: Project Proposal 1, 2nd set of presentations.
- 2/25: Midpoint work in progress report & presentations.
